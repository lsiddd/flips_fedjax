...
class StatefulFedAvgTest(absltest.TestCase):
    ...
    def test_stateful_federated_averaging(self):
        ...
        with self.subTest("apply"):
            ...
            npt.assert_allclose(state.params["w"], [0.0, 1.5655555, 3.131111])
            npt.assert_allclose(
                client_diagnostics[b"cid0"]["delta_l2_norm"], 1.4534444262
            )
            npt.assert_allclose(
                client_diagnostics[b"cid1"]["delta_l2_norm"], 0.2484521282
            )
